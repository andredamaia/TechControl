...
<html lang="en">
    <head>
        ...
        <link rel="mask-icon" href="<?php echo $pageurl; ?>/safari-pinned-tab.svg" color="#0038b8" />
        
        <meta name="msapplication-TileColor" content="#eaeced" />
        <meta name="theme-color" content="#eaecedf" />
        
        <link href="<?php echo $pageurl; ?>/styles/styles.css" rel="stylesheet" />
        
        <meta property="og:type" content="website" />
        <meta property="og:title" content="<?php echo $title; ?>" />
        <meta property="og:description" content="<?php echo $description; ?>" />
        <meta property="og:image" content="<?php echo $pageurl; ?>/images/3bce12a0-f901-4de4-8b20-ff9c798137f5.jpg" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="<?php echo $title; ?>" />
        <meta name="twitter:description" content="<?php echo $description; ?>" />
        <meta name="twitter:image" content="<?php echo $pageurl; ?>/images/3bce12a0-f901-4de4-8b20-ff9c798137f5.jpg" />
    </head>
