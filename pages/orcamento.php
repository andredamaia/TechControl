    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <span class="rodape-title">Queremos entender melhor as necessidades da sua empresa.<br/> Entre em contato por telefone, e-mail ou preencha o formulário<br/> abaixo e nossa equipe entrará em contato com você.</span>
            </div>
...
<div class="area-white orcamento">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8 col-xl-8 offset-md-2 offser-xl-2">
